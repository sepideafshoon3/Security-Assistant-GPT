      ...
      >
        ...
        <div className="flex-1 relative">
          ...
          <textarea
            ...
            rows={1}
            disabled={disabled}
            className="w-full bg-transparent text-gray-100 placeholder-gray-500 focus:outline-none resize-none overflow-y-auto py-2.5 disabled:opacity-50"
